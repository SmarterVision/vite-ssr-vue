import { _ as _export_sfc, a as __vitePreload } from "./index.1b06d063.js";
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case "../components/ImportType.vue":
      return __vitePreload(() => import("./ImportType.bfbbe021.js"), true ? ["assets/ImportType.bfbbe021.js","assets/vendor.0ab654a0.js"] : void 0);
    default:
...
const _withScopeId = (n) => (pushScopeId("data-v-0e1bf21c"), n = n(), popScopeId(), n);
...
const _sfc_main = {
  setup(__props) {
    ...
    const Foo = defineAsyncComponent(() => __vitePreload(() => import("./Foo.973f5eab.js"), true ? ["assets/Foo.973f5eab.js","assets/Foo.a8752494.css","assets/vendor.0ab654a0.js"] : void 0).then((mod) => mod.Foo));
    function load(file) {
...
var Home = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0e1bf21c"]]);
