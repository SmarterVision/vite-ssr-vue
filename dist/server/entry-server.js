...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[--><h1 data-v-daf6bc06>${serverRenderer.ssrInterpolate($setup.msg)}</h1><p class="import-meta-url" data-v-daf6bc06>${serverRenderer.ssrInterpolate($setup.url)}</p>`);
...
var About = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-daf6bc06"]]);
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><h1 data-v-0e1bf21c>Home</h1><p data-v-0e1bf21c><img${serverRenderer.ssrRenderAttr("src", _imports_0)} alt="logo" data-v-0e1bf21c></p><button data-v-0e1bf21c>count is: ${serverRenderer.ssrInterpolate(vue.unref(state).count)}</button>`);
      _push(serverRenderer.ssrRenderComponent(vue.unref(Foo2), null, null, _parent));
      _push(`<p class="virtual" data-v-0e1bf21c>msg from virtual module: ${serverRenderer.ssrInterpolate(vue.unref(foo$1).msg)}</p><p class="inter" data-v-0e1bf21c>this will be styled with a font-face</p><p class="import-meta-url" data-v-0e1bf21c>${serverRenderer.ssrInterpolate(vue.unref(state).url)}</p><p class="protocol" data-v-0e1bf21c>${serverRenderer.ssrInterpolate(vue.unref(state).protocol)}</p><p class="nested-virtual" data-v-0e1bf21c>msg from nested virtual module: ${serverRenderer.ssrInterpolate(vue.unref(msg))}</p>`);
      ...
      _push(`<div data-v-0e1bf21c> encrypted message: <p class="encrypted-msg" data-v-0e1bf21c></p></div>`);
...
var Home = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-0e1bf21c"]]);
